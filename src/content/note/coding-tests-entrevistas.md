...
Fonte: [Why I Stopped Interviewing With Companies That Require a Coding Test — dev.to](https://dev.to/bradstondev/why-i-stopped-interviewing-with-companies-that-require-a-coding-test-2j6n)
